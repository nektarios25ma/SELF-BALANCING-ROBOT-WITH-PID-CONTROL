...
#define PinA_right 3 //Interrupt 1
...
double kp = 50, ki = 1.5, kd = 4.58;//kp = 38, ki = 0, kd = 0.58;//Need you to modify the parameters kp = 30, ki = 0.1, kd = 0.58;
...
double kp_turn = 8, ki_turn = 0, kd_turn = 0.29;        //Rotate PID setting
...
void loop() {
  ...
  attachInterrupt(1, Code_right, CHANGE);
 
 
      
      
// front = 0; back = 0; turnl = 0; turnr = 0; spinl = 0; spinr = 0; turnoutput = 0;  // control steering and reversing smart car
